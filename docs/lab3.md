...
Если мы хотим несколькими способами создавать объекты, то можно определить
...
Все операторы, доступные для перегрузки:
...
> P.S.: Унарный оператор `+` можно сделать и через возвращение нового объекта,
> как это было с оператором `-`.
...
2. 4 арифметических операции c присвоением: `+=`, `-=`, `*=`, `/=`
3. 4 арифметических операции: `+`, `-`, `*`, `/`
4. 2 унарных оператора: `+`, `-`
5. Операторы пре- и пост- инкремента, пре- и пост- декремента.
   Инкремент декремент должны изменять значение числа на наименьшую возможную величину.

*2й пункт не спроста перед 3м*
